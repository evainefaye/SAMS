				    ...
				    $.each(data, function (reportType, reportData) {
					    ...
					    $.each(reportData, function (index, reportRow) {
						    ...
						    case 'TotalCount':
							    ...
							    break;
                            case 'CountByAgent':
							    html = html + '<tr><td class="text-right">' + reportRow.agent_name + '</td><td class="text-right">' + reportRow.agent_name_count + '</td><td class="text-right">' + (reportRow.agent_name_count / totalCount * 100).toFixed(2) + '%</td></tr>';
							    break;
						    case 'CountByBusinessLine':
							    html = html + '<tr><td class="text-right">' + reportRow.business_line + '</td><td class="text-right">' + reportRow.business_line_count + '</td><td class="text-right">' + (reportRow.business_line_count / totalCount *100).toFixed(2) + '%</td></tr>';
							    break;
						    case 'CountByWorkSource':
							    html = html + '<tr><td class="text-right">' + reportRow.work_source + '</td><td class="text-right">' + reportRow.work_source_count + '</td><td class="text-right">' + (reportRow.work_source_count / totalCount *100).toFixed(2) + '%</td></tr>';
							    break;
						    case 'CountByTaskType':
					    ...
					    case 'TotalCount':
						    break;
					    case 'CountByTaskType':
						    html = html + '</tbody><tfoot><tr><th class="sorter-false text-right">TOTAL</th><th class="sorter-false text-right">' + data['TaskTypeTotal']['count'] + '</th><th class="sorter-false">&nbsp;</th></tr></tfoot></table></div>';
						    break;
					    case 'TaskTypeTotal':
						    break;
					    default:
